...
import PastMoreComment from './Modal/PastMoreComment';
...
class ModalComment extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="modal" onClick={isCheck}>
        <button className="close" onClick={isCheck}>
          &times;
        </button>
            ...
            <div className="modal-right-comment">
              <div className="modal-right-comment-author">
                ...
                <div className="modal-right-comment-author-left">
                  ...
                  <div className="modal-right-comment-author-time">
                    {pastTime}
                  </div>
                </div>
              </div>
              {pastCommentList.map((comment, index) => {
                return (
                  <PastMoreComment
                    ...
                    pastTime={comment.commentPastTime}
                  />
                );
              })}
              ...
              {commentList.map((comment, index) => {
                return (
                  <MoreComment
                    key={index}
                    profileImg={
                      '/public/images/geonwoojeon/images/profile/me.jpeg'
                    }
                    author={'raing_8'}
                    title={comment}
                    pastTime={'1초 전'}
